...
public class MockMathService {
    ...
    public Observable<Chapter> chapter(@Path("chapterId") int chapterId) {
        ...
        videos.add(Video.create(1, "Video 1", "Utubeid"));
        videos.add(Video.create(2, "Video 2", "Utubeid"));
        videos.add(Video.create(3, "Video 3", "Utubeid"));
        videos.add(Video.create(4, "Video 4", "Utubeid"));
        videos.add(Video.create(5, "Video 5", "Utubeid"));
